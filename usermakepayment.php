...
if (isset($_POST['submit'])) {
	...
	$k="insert into `tbl_payment` values(null,'$bid','$pri',curdate())";
	insert($k);

	$s="update `tbl_booking` set status='paid' where booking_id='$bid'"; 
	update($s);

	alert("payment successfull");
	return redirect("userviewbooking.php");
}
...
<center> 
	...
	<table>
		...
		<table style="width: 500px; border-radius: 5px;" class="table table-borderless" id="b"> 
			...
			<tr> 
				<td colspan="2" >
					<h6 style="color: rgb(0, 0, 0);font-size: 1em;"> Total :<?php echo $pri ?></h6>
				</td>
			</tr>
			<tr> 
				<td> 
